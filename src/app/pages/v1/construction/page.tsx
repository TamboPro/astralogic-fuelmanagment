// app/pages/construction/page.tsx
'use client'
  ...
  return (
    <div className={`flex h-screen bg-[#141619] text-[#c7d0d9] ${GeistSans.className}`}>
      ...
      <main className="flex-1 overflow-y-auto p-4 text-sm font-light">
        <h1 className="text-2xl font-semibold mb-4">Construction</h1>
        <div className="text-[#8e9297]">
          <p>Cette page est en cours de construction</p>
          <div className="mt-4 p-4 bg-[#202226] rounded-lg max-w-md">
            <div className="flex items-center space-x-2 text-yellow-400">
              <Construction className="w-5 h-5" />
              <span className="font-medium">En développement</span>
            </div>
            <p className="mt-2 text-[#c7d0d9]">
